    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(SelectBluetoothActivity.this, CardioGraphActivity.class);
        ...
        not_found.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SelectBluetoothActivity.this, ScanBluetoothActivity.class);
                startActivity(i);
            }
        });
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        ...
                        Toast.makeText(SelectBluetoothActivity.this, "Turn on bluetooth", Toast.LENGTH_LONG).show();
                        break;
